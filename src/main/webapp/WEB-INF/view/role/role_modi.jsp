...
<head>
    ...
    <body>
        ...
        <div id="main">           
            ...
            <form action="${pageContext.request.contextPath}/role/updateRoleAction" method="post" class="main_form">
                <input type="hidden" name="_method" value="put">
                <input type="hidden" name="rid" value="${role.rid}">
                <div class="text_info clearfix"><span>角色名称：</span></div>
                <div class="input_info">
                    <input type="text" name="rname" class="width200" value="${role.rname}" />
