...
<head>
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="${pageContext.request.contextPath}/role/insertRoleAction" method="post" class="main_form">
                    ...
                    <div class="input_info_scroll">
                        <ul>
                            <c:forEach items="${admin.lp}" var="privs">
                                <li><input name="pids" type="checkbox" value="${privs.pid}">${privs.by001}</li>
                            </c:forEach>
                        </ul>
                    </div>
                    <span class="required">*</span>
